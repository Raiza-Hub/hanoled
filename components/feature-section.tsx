...
const Feature = ({
    ...
    return (
        ...
        >
            {index < 4 && (
                <div className="opacity-0 group-hover/feature:opacity-100 transition duration-200 absolute inset-0 h-full w-full bg-gradient-to-t from-neutral-100 dark:from-zinc-800 to-transparent pointer-events-none" />
            )}
            {index >= 4 && (
            ...
            <div className="text-lg font-bold mb-2 relative z-10 px-10">
                <div className="absolute left-0 inset-y-0 h-6 group-hover/feature:h-8 w-1 rounded-tr-full rounded-br-full bg-zinc-300 dark:bg-zinc-700 group-hover/feature:bg-zinc-500 transition-all duration-200 origin-center" />
